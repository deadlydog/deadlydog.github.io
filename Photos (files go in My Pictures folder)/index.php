...
// CONFIGURATION SECTION - General configuration of the photo gallery
	...
	$WINDOW_TITLE = "Dan and Vanessas Photos - Thanks to Dans One File Photo Gallery";
...
// Heading and Option Settings (these are related to eachother as they are displayed together in the Heading bar)
	...
	$HEADING_TITLE = "Dan and Vanessas Photos";	// Title to appear in the Heading bar
...
// End of Heading and Options settings
	...
	$WELCOME_MESSAGE = "<center>Welcome to our photo album!<br /><br />To download pictures, left click on an image 

...
// CONFIGURATION SECTION - General configuration of the photo gallery
	...
	$WINDOW_TITLE = "Example Photo Album 2 - Thanks to Dans One File Photo Gallery";
...
// End of Heading and Options settings
	...
	$WELCOME_MESSAGE = "<center>Welcome to the photo album!<br /><br />To download pictures, left click on an image 
						to view the full sized image, then right click on that image and choose 'Save Picture/Image As'. 
						If you simply right click on the small thumbnail image and save that one, you will not be 
						downloading the full sized image, but the small thumbnail version of it</center>";
	
	$NUMBER_OF_THUMBNAILS_PER_ROW	= 4;	// Number of thumbnails to display on each row
	...
	$SHOW_ALL_PICTURES_AND_HIDE_DIRECTORY_MENU = $YES;	// ($YES or $NO)

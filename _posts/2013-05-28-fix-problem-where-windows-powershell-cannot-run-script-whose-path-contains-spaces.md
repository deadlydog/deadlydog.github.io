...
__Update__ - This Bonus section now has its own [updated dedicated post here](http://dans-blog.azurewebsites.net/keep-powershell-console-window-open-after-script-finishes-running/) that you should use instead.
